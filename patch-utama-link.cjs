...
const targetInfo = `<h2 className="text-xl font-bold text-slate-800 mb-4">Info SMAG3</h2>
...
const newInfo = `<h2 className="text-xl font-bold text-slate-800 mb-4 flex justify-between items-center">
            Info SMAG3
...
console.log('Patched Utama.tsx with facebook link');
